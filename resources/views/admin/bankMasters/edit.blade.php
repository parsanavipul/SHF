...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.bankMaster.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.bank-masters.update", [$bankMaster->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="bankname">{{ trans('cruds.bankMaster.fields.bankname') }}</label>
                <input class="form-control {{ $errors->has('bankname') ? 'is-invalid' : '' }}" type="text" name="bankname" id="bankname" value="{{ old('bankname', $bankMaster->bankname) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('billing_start_at') ? 'is-invalid' : '' }}" type="text" name="billing_start_at" id="billing_start_at" value="{{ old('billing_start_at', $bankMaster->billing_start_at) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('billing_end_at') ? 'is-invalid' : '' }}" type="text" name="billing_end_at" id="billing_end_at" value="{{ old('billing_end_at', $bankMaster->billing_end_at) }}" required>
